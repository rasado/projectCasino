	...
	*/
    ...
    public static void playWar(){
        ...
        while(wantToPlayWar && credit>0){
            ...
            System.out.println("Your cards: " + playerCard.toString());
            Card computerCard = myDeck.drawNextCard();
            System.out.println("Dealers cards: " + computerCard.toString());
            if(playerCard.isHigherThan(computerCard)){
                credit = credit + bet;
                System.out.println("You won. You get " + bet + " dollars. Now you have " + credit + " dollars.");
            }else{
                credit = credit - bet;
                System.out.println("House wins. You lose " + bet + " dollars. Now you have " + credit + " dollars.");
            }
            ...
            if (credit>0){
                ...
                System.out.println("I'm sorry, you ran out of money. The house always wins!");
            }
        }
    }
    /*
    ...
    */
    ...
    public static boolean wantToKeepPlaying(){
        ...
        if(reply.charAt(0) == 'y' || reply.charAt(0) == 'Y'){
            ...
            System.out.println("Thank you for playing at the Blackjack table. Best of luck in your future endeavours ");
            return false;
        }
    }
}